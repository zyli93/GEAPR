...
CMD = """
CUDA_VISIBLE_DEVICES=6 python3 src-abla/main_zyli.py \
    --trial_id {} \
    --ae_layers {} \
    --is_training \
    --epoch 10 \
...
CONFIGS = {
    ...
    "negative_sample_ratio": [90],  # [1, 3, 5],  # 3
    ...
    "hid_rep_dim": [32],  # 1
    "tao": [0],  # 1
    "gat_ft_dropout": [0],  # [0.1, 0.3, 0.5],  # 3
    "gat_coef_dropout": [0],  # [0.1, 0.3, 0.5],  # 3
    "afm_dropout_rate": [0.2],  # [0.1, 0.3, 0.5],  # 3
